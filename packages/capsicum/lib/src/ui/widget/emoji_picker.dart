...
const _unicodeEmojiCategories = <String, List<String>>{
  'よく使う': [
    '\u{1F44D}', '\u{2764}\u{FE0F}', '\u{1F602}', '\u{1F60A}', '\u{1F389}',
    '\u{1F44F}', '\u{1F914}', '\u{1F62D}', '\u{1F631}', '\u{1F525}',
    '\u{2728}', '\u{1F64F}', '\u{1F60D}', '\u{1F917}', '\u{1F4AA}',
    '\u{1F44C}', '\u{1F4AF}', '\u{1F3B6}', '\u{2705}', '\u{274C}',
  ],
  'スマイリー': [
  ...
  'ジェスチャー': [
    '\u{1F44D}', '\u{1F44E}', '\u{1F44F}', '\u{1F64C}', '\u{1F450}',
    '\u{1F91D}', '\u{1F64F}', '\u{270D}\u{FE0F}', '\u{1F485}', '\u{1F4AA}',
    '\u{1F44A}', '\u{270A}', '\u{1F91B}', '\u{1F91C}', '\u{1F44C}',
    '\u{1F90F}', '\u{270C}\u{FE0F}', '\u{1F91E}', '\u{1F91F}', '\u{1F918}',
  ],
  'ハート': [
    '\u{2764}\u{FE0F}', '\u{1F9E1}', '\u{1F49B}', '\u{1F49A}', '\u{1F499}',
    '\u{1F49C}', '\u{1F5A4}', '\u{1FA76}', '\u{1F90D}', '\u{1F49D}',
    '\u{1F49E}', '\u{1F493}', '\u{1F497}', '\u{1F496}', '\u{1F498}',
    '\u{1F49F}', '\u{1F48C}',
  ],
};
...
class _EmojiPickerState extends State<EmojiPicker>
  ...
  Future<void> _loadCustomEmojis() async {
    ...
    try {
      final emojis =
          await (widget.adapter as CustomEmojiSupport).getEmojis();
