...
///
/// **適用先は Mastodon / Misskey のクライアントだけではない。** モロヘイヤの
/// `MulukhiyaService` が抱える Dio（生成は `account_manager_provider.dart` の
/// `_detectMulukhiya`）にも同じ値を当てている (#951)。あちらは #900 の取りこぼしで
/// receive / send が無制限のまま残っており、プッシュ登録が無限ハングしうる形だった。
/// **アプリ内で長寿命の Dio を新設するときは、ここの値を当てたか確認すること。**
///
/// ## 値の考え方
///
