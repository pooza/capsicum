...
最新リリース: **v1.15.0**（2026-04-15、App Store 審査提出済み / Google Play 公開済み）。v1.0.0 は 2026-03-14 にストア公開。リリース履歴の詳細は [GitHub Releases](https://github.com/pooza/capsicum/releases) を参照。

今後のマイルストーン:

- **v1.15** — 観測性 + 絵文字一掃 + 小改善（iOS 通知観測性強化・ログイン不具合・サーバー別背景画像・Bearer トークン変更・ゼロ幅スペースオプション）
