...
GitHub Issues のマイルストーン（v1.0 / v1.1 / v1.2 / v1.3 / v1.4 / v1.5 / v1.6 / v1.7 / v1.8 / v1.9 / v1.10 / v1.11 / v1.12 / v1.13 / v1.14 / v1.15 / v1.16）が正本。個別 Issue の一覧・ステータスはここに複写しない。
...
- **v1.14** — 通知統合 + UX 改善（通知・お知らせ統合一覧・通知タブ化・iOS通知バグ・投稿内容消失・TLジャンプ・ブースト公開範囲・実況フィルタボット判定・ログイン調査）
