...
GitHub Issues のマイルストーン（v1.0 / v1.1 / v1.2 / v1.3 / v1.4 / v1.5 / v1.6）が正本。個別 Issue の一覧・ステータスはここに複写しない。
...
- **v1.4** — UX 改善・Misskey 機能拡充（URL 短縮表示・t.co 展開・ティッカー改善・テーマカラー・フォントサイズ 等）
- **v1.5** — 追加機能
- **v1.6** — 追加機能
