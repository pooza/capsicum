...
|---|---|---|---|---|
| [#54](https://github.com/pooza/capsicum/issues/54) | ATOK で日本語入力が二重になる (iOS) | **本命 family 特定**: [flutter/flutter#149379](https://github.com/flutter/flutter/issues/149379) (macOS, OPEN, 確定時に文節二重化) ← 本質は [flutter/flutter#160935](https://github.com/flutter/flutter/issues/160935) (macOS, CLOSED / r: fixed, 「…帰ります家に帰ります」型の文節二重化で #54 と同症状)。macOS 修正 PR [flutter/flutter#166291](https://github.com/flutter/flutter/pull/166291) (MERGED 2025-06-21) は `darwin/macos/.../FlutterTextInputPlugin.mm` 1 ファイルのみ＝**macOS 専用、iOS 経路 (`darwin/ios/.../FlutterTextInputPlugin.mm`) は未修正**。関連: [#96092](https://github.com/flutter/flutter/issues/96092) (Android ATOK, OPEN) / [#151103](https://github.com/flutter/flutter/issues/151103) / [#134926](https://github.com/flutter/flutter/issues/134926) (web) / [#154692](https://github.com/flutter/flutter/issues/154692) (Windows 同型) | 2026-06-06 | **chase で root-cause family 特定**。darwin FlutterTextInputPlugin の IME composing 確定処理の二重適用。macOS は #166291 で修正済みだが iOS 版は未修正・iOS 特化 upstream issue も未起票。報告者の追加情報（ATOK「従来のカーソル位置入力を使用」ON で回避可＝モダンな inline composing 経路が触媒）とも整合。次アクション: macOS 修正 #166291 を範に iOS FlutterTextInputPlugin への同型修正を求める iOS upstream issue 起票を検討（pooza 判断） |
