...
| [#463](https://github.com/pooza/capsicum/issues/463) | 入力エラー: かっこ等の変換が確定できずカーソルがワード左に飛ぶ (Android / Samsung Keyboard) | 上流 issue 未調査。chase 時に flutter/flutter で "Samsung Keyboard" / "Galaxy" / IME composing 系を探索 | 2026-05-11 | capsicum 側の全 TextField 共通触媒は棚卸しで確認できず (inputDecorationTheme / textSelectionTheme / 共通 TextInputFormatter / 独自 FocusNode / HardwareKeyboard listener いずれもなし)。#54 ATOK と同型の Flutter + 特定 IME 由来。Gboard で回避可能 |
