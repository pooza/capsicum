...
|---|---|---|---|---|
| [#54](https://github.com/pooza/capsicum/issues/54) | ATOK で日本語入力が二重になる (iOS) | iOS 特化の上流 issue 未発見。関連: [flutter/flutter#96092](https://github.com/flutter/flutter/issues/96092) (Android, OPEN), [flutter/flutter#151103](https://github.com/flutter/flutter/issues/151103) (web, OPEN) / [#134926](https://github.com/flutter/flutter/issues/134926) (web) | 2026-06-02 | 上流 issue 未特定（Android/web の関連は open、iOS 本命なし。変化なし） |
